...
<body class="hold-transition skin-purple sidebar-mini">
                ...
                <div class="box-body">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#tab-form" data-toggle="tab">会员表单</a>
                            </li>
                        </ul>
                        <!--tab头/-->
                            ...
                            <div class="tab-pane active" id="tab-form">
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="会员号"  name="huiyuanId">
                                    </div>

                                    <div class="col-md-2 title">积分</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="积分" name="huiyuanjifen">
                                    </div>
									<div class="box-tools text-center">
										<button type="submit" class="btn bg-maroon" id="update">更新</button>
										<%--<button type="button" class="btn bg-maroon" id="insert">添加</button>--%>
    ...
    <script>
        ...
        function edit(id,point) {
            alert(id.valueOf());
            $.ajax({
                url: '<%=basePath%>/updateMember',
                dataType: 'json',
